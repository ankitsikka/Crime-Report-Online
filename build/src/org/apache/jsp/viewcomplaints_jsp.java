    ...
    try {
      ...
      out.write("                                                ");
         ...
         String url="jdbc:mysql://localhost/crimefiledb";                  
            ...
            out.println("<td >" +counter+".  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href='viewdetailsclient.jsp?id="+fir+"'>" +myresult.getString("firno")+"</a>    &nbsp&nbsp&nbsp&nbsp" + myresult.getString("status")+"    &nbsp&nbsp&nbsp&nbsp&nbsp"
            ...
            out.println("<td >" +counter+".  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href='viewdetailsclient.jsp?id="+fir+"'>" +myresult1.getString("firno")+"</a>    &nbsp&nbsp&nbsp&nbsp" + myresult1.getString("status")+"    &nbsp&nbsp&nbsp&nbsp&nbsp"
